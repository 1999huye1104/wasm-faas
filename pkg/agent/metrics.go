...
var (
	...
	wasmfunctionCalls = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "faas_wasm_function_calls_total",
			Help: "Count of Fission function calls",
		},
		labelsStrings,
	)
	wasmfunctionCallErrors = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "faas_wasm_function_errors_total",
			Help: "Count of Fission function errors",
		},
		labelsStrings,
	)
	wasmfunctionCallOverhead = promauto.NewSummaryVec(
		prometheus.SummaryOpts{
			Name:       "faas_wasm_function_overhead_seconds",
